    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_verified', models.BooleanField(default=True, help_text='Set to true when the user have verified its email add', verbose_name='verified')),
                ('type_identification', models.CharField(help_text='type of user identification document: CC or TI.', max_length=2)),
                ('identification_number', models.CharField(max_length=11, validators=[django.core.validators.RegexValidator(message='Identification number must be entered in the format: 199999999. Up to 11 digits allowed', regex='\\1\\d{6,10}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.PositiveIntegerField(default=0, help_text='user weight in float.', verbose_name='user weight')),
