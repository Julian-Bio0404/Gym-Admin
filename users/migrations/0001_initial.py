    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('admin', 'admin'), ('physio', 'physio'), ('trainer', 'trainer'), ('client', 'client')], default='client', help_text='Help easily distinguish users and perform queries. Clients are the main type of user.', max_length=7, verbose_name='rol')),
                ...
                ('identification_number', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator(message='Identification number must be entered in the format: 199999999. Up to 11 digits allowed', regex='\\d{6,10}$')])),
